...
#ifndef RESOURCE_OHOS_ABILITY_RUNTIME_ABILITY_STATE_SECOND_H
#define RESOURCE_OHOS_ABILITY_RUNTIME_ABILITY_STATE_SECOND_H
#include <string>
...
#endif  // RESOURCE_OHOS_ABILITY_RUNTIME_ABILITY_STATE_SECOND_H
