...
{
    HILOG_INFO("AmsStAbilityN2::Init");
...
{
    GetWantInfo(want);
    HILOG_INFO("AmsStAbilityN2::onStart");
...
{
    HILOG_INFO("AmsStAbilityN2::OnNewWant");
...
{
    HILOG_INFO("AmsStAbilityN2::onStop");
    Ability::OnStop();
...
{
    HILOG_INFO("AmsStAbilityN2::OnActive");
    Ability::OnActive();
...
{
    HILOG_INFO("AmsStAbilityN2::OnInactive");
    Ability::OnInactive();
...
{
    HILOG_INFO("AmsStAbilityN2::OnBackground");
