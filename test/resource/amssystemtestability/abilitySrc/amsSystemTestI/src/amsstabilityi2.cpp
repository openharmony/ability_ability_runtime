...
void AmsStAbilityI2::OnStart(const Want &want)
{
    ...
    HILOG_INFO("AmsStAbilityI2::onStart");
...
{
    HILOG_INFO("AmsStAbilityI2::OnNewWant");
...
{
    HILOG_INFO("AmsStAbilityI2::onStop");
    Ability::OnStop();
...
{
    HILOG_INFO("AmsStAbilityI2::OnActive");
    Ability::OnActive();
...
{
    HILOG_INFO("AmsStAbilityI2::OnInactive");
    Ability::OnInactive();
...
{
    HILOG_INFO("AmsStAbilityI2::OnBackground");
