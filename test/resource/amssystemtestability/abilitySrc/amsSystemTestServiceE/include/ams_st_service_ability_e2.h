...
#ifndef RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_SERVICE_ABILITY_E2_H
#define RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_SERVICE_ABILITY_E2_H
...
const std::string APP_E2_RESP_EVENT_NAME = "resp_com_ohos_amsst_service_app_e2";
const std::string APP_E2_REQ_EVENT_NAME = "req_com_ohos_amsst_service_app_e2";
class AmsStServiceAbilityE2 : public Ability {
public:
    ~AmsStServiceAbilityE2();
...
private:
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(APP_E2_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(APP_E2_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        AmsStServiceAbilityE2 *mainAbility_ = nullptr;
    };
    class MyRemoteObject : public IRemoteObject {
    public:
        void GetDataByDataAbility();
    };
};
...
#endif  // RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_SERVICE_ABILITY_E2_H
