 ...
 */
#ifndef RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_DATA_ABILITY_PAGE_B_H
#define RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_DATA_ABILITY_PAGE_B_H
#include <vector>
#include <string>
...
#endif  // RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_DATA_ABILITY_PAGE_B_H
