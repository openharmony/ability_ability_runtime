...
#include "amsstabilityg1.h"

namespace OHOS {
namespace AppExecFwk {
void AmsStAbilityG1::OnStart(const Want &want)
{
    GetWantInfo(want);

    HILOG_INFO("AmsStAbilityG1::onStart");
...
void AmsStAbilityG1::OnNewWant(const Want &want)
{
    HILOG_INFO("AmsStAbilityG1::OnNewWant");
...
void AmsStAbilityG1::OnForeground(const Want &want)
{
    HILOG_INFO("AmsStAbilityG1::OnForeground");
...
void AmsStAbilityG1::OnStop()
{
    HILOG_INFO("AmsStAbilityG1::onStop");
    Ability::OnStop();
...
void AmsStAbilityG1::OnActive()
{
    HILOG_INFO("AmsStAbilityG1::OnActive");
    Ability::OnActive();
...
void AmsStAbilityG1::OnInactive()
{
    HILOG_INFO("AmsStAbilityG1::OnInactive");
    Ability::OnInactive();
...
void AmsStAbilityG1::OnBackground()
{
    HILOG_INFO("AmsStAbilityG1::OnBackground");
...
void AmsStAbilityG1::GetWantInfo(const Want &want)
{
    Want mWant(want);
