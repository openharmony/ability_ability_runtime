...
const std::string APP_B2_RESP_EVENT_NAME = "resp_com_ohos_amsst_service_app_b2";
const std::string APP_B1_REQ_EVENT_NAME = "req_com_ohos_amsst_service_app_b2";
class AmsStServiceAbilityB2 : public Ability {
public:
...
private:
    ...
    typedef void (AmsStServiceAbilityB2::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(APP_B2_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(APP_B2_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        AmsStServiceAbilityB2 *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
