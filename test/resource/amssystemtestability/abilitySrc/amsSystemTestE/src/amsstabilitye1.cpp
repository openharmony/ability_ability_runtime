...
#include "amsstabilitye1.h"

namespace OHOS {
namespace AppExecFwk {
void AmsStAbilityE1::OnStart(const Want &want)
{
    GetWantInfo(want);

    HILOG_INFO("AmsStAbilityE1::onStart");
...
void AmsStAbilityE1::OnForeground(const Want &want)
{
    HILOG_INFO("AmsStAbilityE1::OnForeground");
...
void AmsStAbilityE1::OnNewWant(const Want &want)
{
    HILOG_INFO("AmsStAbilityE1::OnNewWant");
...
void AmsStAbilityE1::OnStop()
{
    HILOG_INFO("AmsStAbilityE1::onStop");
    Ability::OnStop();
...
void AmsStAbilityE1::OnActive()
{
    HILOG_INFO("AmsStAbilityE1::OnActive");
    Ability::OnActive();
...
void AmsStAbilityE1::OnInactive()
{
    HILOG_INFO("AmsStAbilityE1::OnInactive");
    Ability::OnInactive();
...
void AmsStAbilityE1::OnBackground()
{
    HILOG_INFO("AmsStAbilityE1::OnBackground");
...
void AmsStAbilityE1::GetWantInfo(const Want &want)
{
    Want mWant(want);
