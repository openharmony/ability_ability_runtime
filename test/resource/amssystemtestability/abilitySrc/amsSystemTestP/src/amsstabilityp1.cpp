...
{
    GetWantInfo(want);
    HILOG_INFO("AmsStAbilityP1::onStart");
...
{
    HILOG_INFO("AmsStAbilityP1::OnNewWant");
...
{
    HILOG_INFO("AmsStAbilityP1::OnForeground");
...
{
    HILOG_INFO("AmsStAbilityP1::OnActive");
    Ability::OnActive();
...
{
    HILOG_INFO("AmsStAbilityP1::OnInactive");
    Ability::OnInactive();
