...
#include "amsstabilityf3.h"

namespace OHOS {
namespace AppExecFwk {
void AmsStAbilityF3::OnStart(const Want &want)
{
    GetWantInfo(want);
...
void AmsStAbilityF3::GetWantInfo(const Want &want)
{
    Want mWant(want);
