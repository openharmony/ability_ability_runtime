 ...
 */
#ifndef RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_KIT_DATA_ABILITY_DATA_A3_H
#define RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_KIT_DATA_ABILITY_DATA_A3_H
#include <string>
...
class KitTestDataA3EventSubscriber;
class AmsStKitDataAbilityDataA3 : public Ability {
public:
...
private:
    Want originWant_;
    std::shared_ptr<KitTestDataA3EventSubscriber> subscriber_;
};

class AmsStKitDataAbilityDataA3LifecycleCallbacks : public AbilityLifecycleCallbacks {
public:
    AmsStKitDataAbilityDataA3LifecycleCallbacks() = default;
    virtual ~AmsStKitDataAbilityDataA3LifecycleCallbacks() = default;
    ...
    AmsStKitDataAbilityDataA3 *mainAbility_;
};

class AmsStKitDataAbilityDataA3LifecycleObserver : public ILifecycleObserver {
public:
    AmsStKitDataAbilityDataA3LifecycleObserver() = default;
    virtual ~AmsStKitDataAbilityDataA3LifecycleObserver() = default;
...
class KitTestDataA3EventSubscriber : public CommonEventSubscriber {
public:
    explicit KitTestDataA3EventSubscriber(const CommonEventSubscribeInfo &sp) : CommonEventSubscriber(sp)
    {
    ...
    AmsStKitDataAbilityDataA3 *mainAbility_;
    ~KitTestDataA3EventSubscriber() {};
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_KIT_DATA_ABILITY_DATA_A3_H
