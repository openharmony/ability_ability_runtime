...
#include "amsstabilityd2.h"

namespace OHOS {
namespace AppExecFwk {
void AmsStAbilityD2::OnStart(const Want &want)
{
    GetWantInfo(want);
...
void AmsStAbilityD2::OnForeground(const Want &want)
{
    HILOG_INFO("AmsStAbilityD2::OnForeground");
...
void AmsStAbilityD2::OnNewWant(const Want &want)
{
    HILOG_INFO("AmsStAbilityD2::OnNewWant");
...
void AmsStAbilityD2::OnStop()
{
    HILOG_INFO("AmsStAbilityD2::onStop");
    Ability::OnStop();
...
void AmsStAbilityD2::OnActive()
{
    HILOG_INFO("AmsStAbilityD2::OnActive");
    Ability::OnActive();
...
void AmsStAbilityD2::OnInactive()
{
    HILOG_INFO("AmsStAbilityD2::OnInactive");
    Ability::OnInactive();
...
void AmsStAbilityD2::OnBackground()
{
    HILOG_INFO("AmsStAbilityD2::OnBackground");
...
void AmsStAbilityD2::GetWantInfo(const Want &want)
{
    Want mWant(want);
