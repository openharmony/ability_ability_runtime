...
#include "amsstabilityd1.h"

namespace OHOS {
namespace AppExecFwk {
void AmsStAbilityD1::OnStart(const Want &want)
{
    GetWantInfo(want);

    HILOG_INFO("AmsStAbilityD1::onStart");
...
void AmsStAbilityD1::OnForeground(const Want &want)
{
    HILOG_INFO("AmsStAbilityD1::OnForeground");
...
void AmsStAbilityD1::OnNewWant(const Want &want)
{
    HILOG_INFO("AmsStAbilityD1::OnNewWant");
...
void AmsStAbilityD1::OnStop()
{
    HILOG_INFO("AmsStAbilityD1::onStop");
    Ability::OnStop();
...
void AmsStAbilityD1::OnActive()
{
    HILOG_INFO("AmsStAbilityD1::OnActive");
    Ability::OnActive();
...
void AmsStAbilityD1::OnInactive()
{
    HILOG_INFO("AmsStAbilityD1::OnInactive");
    Ability::OnInactive();
...
void AmsStAbilityD1::OnBackground()
{
    HILOG_INFO("AmsStAbilityD1::OnBackground");
...
void AmsStAbilityD1::GetWantInfo(const Want &want)
{
    Want mWant(want);
