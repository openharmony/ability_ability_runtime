 ...
 */
#ifndef RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_KIT_DATA_ABILITY_DATA_B_H
#define RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_KIT_DATA_ABILITY_DATA_B_H
#include <string>
...
class KitTestDataBEventSubscriber;
class AmsStKitDataAbilityDataB : public Ability {
public:
...
private:
    Want originWant_;
    std::shared_ptr<KitTestDataBEventSubscriber> subscriber_;
};

class AmsStKitDataAbilityDataBLifecycleCallbacks : public AbilityLifecycleCallbacks {
public:
    AmsStKitDataAbilityDataBLifecycleCallbacks() = default;
    virtual ~AmsStKitDataAbilityDataBLifecycleCallbacks() = default;
    ...
    AmsStKitDataAbilityDataB *mainAbility_;
};

class AmsStKitDataAbilityDataBLifecycleObserver : public ILifecycleObserver {
public:
    AmsStKitDataAbilityDataBLifecycleObserver() = default;
    virtual ~AmsStKitDataAbilityDataBLifecycleObserver() = default;
...
class KitTestDataBEventSubscriber : public CommonEventSubscriber {
public:
    KitTestDataBEventSubscriber(const CommonEventSubscribeInfo &sp, AmsStKitDataAbilityDataB *ability)
    ...
    AmsStKitDataAbilityDataB *mainAbility_;
    ~KitTestDataBEventSubscriber() {};
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // RESOURCE_OHOS_ABILITY_RUNTIME_AMS_ST_KIT_DATA_ABILITY_DATA_B_H
