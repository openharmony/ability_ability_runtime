...
{
    uint32_t code = GetU32Data(data) % (static_cast<uint32_t>(IAmsMgr::Message::END));
    ...
    std::shared_ptr<AmsMgrScheduler> amsMgr = std::make_shared<AmsMgrScheduler>(appMgrServiceInner, handler);
