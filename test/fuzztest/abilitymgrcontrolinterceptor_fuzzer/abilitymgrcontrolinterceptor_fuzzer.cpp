...
#include "abilitymgrcontrolinterceptor_fuzzer.h"
...
{
    std::shared_ptr<ControlInterceptor> executer = std::make_shared<ControlInterceptor>();
    Want want;
    ...
    executer->CheckControl(want, userId, controlRule);
    return true;
}
}
