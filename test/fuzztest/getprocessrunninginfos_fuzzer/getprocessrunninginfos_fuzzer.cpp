...
#include "getprocessrunninginfos_fuzzer.h"
...
bool DoSomethingInterestingWithMyAPI(FuzzedDataProvider *fdp)
{
    ...
    sptr<RunningProcessInfo> info = RunningProcessInfo::Unmarshalling(parcel);
    RunningProcessInfo processInfo = *info;
    ...
    abilityMgr->GetProcessRunningInfos(infos);
