...
bool DoSomethingInterestingWithMyAPI(const char* data, size_t size)
{
    ...
    std::shared_ptr<AtomicServiceStatusCallbackStub> atomicservicestatuscallbackstub
        = std::make_shared<AtomicServiceStatusCallbackStubFuzzTest>();

    atomicservicestatuscallbackstub->OnRemoteRequest(code, parcel, reply, option);
