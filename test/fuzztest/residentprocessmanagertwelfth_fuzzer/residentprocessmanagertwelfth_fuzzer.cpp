...
#include "residentprocessmanagertwelfth_fuzzer.h"
...
bool DoSomethingInterestingWithMyAPI(const uint8_t* data, size_t size)
{
    ...
    residentProcessManager->AddFailedResidentAbility(bundleName, abilityName, userId);
    residentProcessManager->StartFailedResidentAbilities();
    return true;
}
}
