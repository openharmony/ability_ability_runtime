...
#include "abilitystubstartabilityascallerforoptions_fuzzer.h"
...
{
    uint32_t code = static_cast<uint32_t>(AbilityManagerInterfaceCode::START_ABILITY_AS_CALLER_FOR_OPTIONS);
    ...
    DelayedSingleton<AbilityManagerService>::GetInstance()->uiAbilityLifecycleManager_ =
