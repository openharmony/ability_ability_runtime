...
#include "appmgrstubfirst_fuzzer.h"
...
const std::u16string AMSMGR_INTERFACE_TOKEN = u"ohos.aafwk.AppManager";
bool DoSomethingInterestingWithMyAPI(const uint8_t* data, size_t size)
{
    ...
    parcel.RewindRead(0);
    appMgrStub->HandleRegisterKiaInterceptor(parcel, reply);
    return true;
}
}
