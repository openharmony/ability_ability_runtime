...
#include "abilitystubregisterremotemissionlistener_fuzzer.h"
...
{
    uint32_t code = static_cast<uint32_t>(AbilityManagerInterfaceCode::REGISTER_REMOTE_MISSION_LISTENER);
