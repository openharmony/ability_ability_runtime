...
{
    uint32_t code = static_cast<uint32_t>(IChildScheduler::Message::SCHEDULE_LOAD_JS);
    ...
    std::shared_ptr<ChildSchedulerStub> abms = std::make_shared<ChildSchedulerStubFUZZ>();
