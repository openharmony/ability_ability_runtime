 ...
 */
#include "abilityappmgreventthird_fuzzer.h"
...
bool DoSomethingInterestingWithMyAPI(const char* data, size_t size)
{
    ...
    AppMgrEventUtil::SendProcessStartFailedEvent(nullptr, nullptr, eventInfo);
    AppMgrEventUtil::SendProcessStartFailedEvent(callerAppRecord, nullptr, eventInfo);
    AppMgrEventUtil::SendProcessStartFailedEvent(nullptr, appRecord, eventInfo);
