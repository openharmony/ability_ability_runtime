...
public:
    ...
    void
    OnAbilityCreate(const std::shared_ptr<NativeReference> &ability) override{};
    void OnWindowStageCreate(
        const std::shared_ptr<NativeReference> &ability,
    ...
    void OnWindowStageInactive(
        ...
        const std::shared_ptr<NativeReference> &windowStage) override{};
    void
    OnAbilityDestroy(const std::shared_ptr<NativeReference> &ability) override{};
