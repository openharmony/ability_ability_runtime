...
#include "abilitystubmovemissiontosplitscreenstackdone_fuzzer.h"
...
{
    uint32_t code = static_cast<uint32_t>(AbilityManagerInterfaceCode::MOVE_MISSION_TO_FLOATING_STACK);
