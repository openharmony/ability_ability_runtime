...
#include "abilitystubunregisterremotemissionlistener_fuzzer.h"
...
{
    uint32_t code = static_cast<uint32_t>(AbilityManagerInterfaceCode::UNREGISTER_REMOTE_MISSION_LISTENER);
