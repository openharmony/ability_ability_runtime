...
#include "crowdtestinterceptor_fuzzer.h"

#include <cstddef>
#include <cstdint>

#define private public
#include "crowd_test_interceptor.h"
#undef private
...
bool DoSomethingInterestingWithMyAPI(const char *data, size_t size)
{
    ...
    std::shared_ptr<CrowdTestInterceptor> crowdTestInterceptor = std::make_shared<CrowdTestInterceptor>();
    Want want;
