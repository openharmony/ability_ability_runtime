...
#ifndef OHOS_ABILITY_RUNTIME_MOCK_IMAGE_ERROR_HANDLER_STUB_H
#define OHOS_ABILITY_RUNTIME_MOCK_IMAGE_ERROR_HANDLER_STUB_H
...
#endif // OHOS_ABILITY_RUNTIME_MOCK_IMAGE_ERROR_HANDLER_STUB_H