...
public:
    ...
    static std::vector<AppExecFwk::DisposedRule> mockDisposedRuleList_;
    static int retGetAbilityRunningControlRule_;
    static bool retCreateModalUIExtension_;
    static int retAbilityRecordCreateModalUIExtension_;
