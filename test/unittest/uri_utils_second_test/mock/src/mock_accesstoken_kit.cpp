...
{
    nativeTokenInfoRes.processName = MyFlag::bundleName_;
    if (nativeTokenInfoRes.processName != "") {
        return 0;
    }
    return -1;
}
...
{
    hapInfo.instIndex = BASE_USER_RANGE;
    hapInfo.bundleName = MyFlag::bundleName_;
    hapInfo.apiVersion = MyFlag::getTokenIdByBundleNameStatus_;
    if (hapInfo.bundleName != "") {
        return 0;
    }
    return -1;
}
