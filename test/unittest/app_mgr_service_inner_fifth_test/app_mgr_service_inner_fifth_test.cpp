...
/**
 * @tc.name: ResolveProcessName_005
 * @tc.desc: NewProcessMode should generate new process name
 * @tc.type: FUNC
 */
HWTEST_F(AppMgrServiceInnerTest, ResolveProcessName_005, TestSize.Level2)
{
    auto appMgrServiceInner = std::make_shared<AppMgrServiceInner>();
    auto abilityInfo = std::make_shared<AppExecFwk::AbilityInfo>();
    auto appInfo = std::make_shared<AppExecFwk::ApplicationInfo>();
    ...
    abilityInfo->bundleName = "com.test.bundle";
    abilityInfo->moduleName = "moduleA";
    abilityInfo->name = "AbilityC";
    std::string processName;
    appMgrServiceInner->ResolveProcessName(abilityInfo, appInfo, hapModuleInfo, 0, "",
        static_cast<int32_t>(AAFwk::ProcessMode::NEW_PROCESS_ATTACH_TO_PARENT), 100, processName);
    EXPECT_FALSE(processName.empty());
    EXPECT_NE(processName.find("com.test.bundle"), std::string::npos);
    EXPECT_NE(processName.find("AbilityC"), std::string::npos);
}

/**
 * @tc.name: ResolveProcessName_006
 * @tc.desc: Non-NewProcessMode with empty flag, should call MakeProcessName
 * @tc.type: FUNC
 */
HWTEST_F(AppMgrServiceInnerTest, ResolveProcessName_006, TestSize.Level2)
{
    auto appMgrServiceInner = std::make_shared<AppMgrServiceInner>();
    auto abilityInfo = std::make_shared<AppExecFwk::AbilityInfo>();
    auto appInfo = std::make_shared<AppExecFwk::ApplicationInfo>();
...
/**
 * @tc.name: ResolveProcessName_007
 * @tc.desc: Non-NewProcessMode with non-empty flag, should call MakeProcessName with flag
 * @tc.type: FUNC
 */
HWTEST_F(AppMgrServiceInnerTest, ResolveProcessName_007, TestSize.Level2)
{
    auto appMgrServiceInner = std::make_shared<AppMgrServiceInner>();
    auto abilityInfo = std::make_shared<AppExecFwk::AbilityInfo>();
    auto appInfo = std::make_shared<AppExecFwk::ApplicationInfo>();
...
/**
 * @tc.name: ResolveProcessName_008
 * @tc.desc: Null abilityInfo in NewProcessMode should return early without crash
 * @tc.type: FUNC
 */
HWTEST_F(AppMgrServiceInnerTest, ResolveProcessName_008, TestSize.Level2)
{
    auto appMgrServiceInner = std::make_shared<AppMgrServiceInner>();
    auto appInfo = std::make_shared<AppExecFwk::ApplicationInfo>();
    AppExecFwk::HapModuleInfo hapModuleInfo;
