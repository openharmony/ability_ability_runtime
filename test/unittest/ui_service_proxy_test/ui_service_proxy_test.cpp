...
void UIServiceProxyTest::SetUpTestCase()
{}

void UIServiceProxyTest::TearDownTestCase()
{}
 ...
 */
HWTEST_F(UIServiceProxyTest, SendData_0100, TestSize.Level1)
{
    TAG_LOGI(AAFwkTag::TEST, "SendData_0100 start");
    sptr<IRemoteObject> impl;
    std::shared_ptr<AAFwk::UIServiceProxy> Info = std::make_shared<AAFwk::UIServiceProxy>(impl);
    OHOS::AAFwk::WantParams data;
    sptr<IRemoteObject> hostProxy = nullptr;
    int32_t res = Info->SendData(hostProxy, data);
 ...
 * @tc.desc: SystemAbilityStatusChangeListener SendData
 */
HWTEST_F(UIServiceProxyTest, SendData_0200, TestSize.Level1)
{
...
/**
 * @tc.number: SendData_0300
 * @tc.name: SendData
 * @tc.desc: SystemAbilityStatusChangeListener SendData
 */
HWTEST_F(UIServiceProxyTest, SendData_0300, TestSize.Level1)
{
    TAG_LOGI(AAFwkTag::TEST, "SendData_0300 start");
    ...
    TAG_LOGI(AAFwkTag::TEST, "SendData_0300 end");
}
