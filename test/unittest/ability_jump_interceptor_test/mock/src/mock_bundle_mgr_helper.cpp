...
{
    name = AAFwk::MyFlag::callerBundleName_;
    return AAFwk::MyFlag::retGetNameForUid_;
}
...
bool BundleMgrHelper::QueryAbilityInfo(const AAFwk::Want &want, int32_t flags,
    int32_t userId, AbilityInfo &abilityInfo)
{
    abilityInfo = AAFwk::MyFlag::retAbilityInfo_;
    return AAFwk::MyFlag::retQueryAbilityInfo_;
}
} // namespace AppExecFwk
} // namespace OHOS