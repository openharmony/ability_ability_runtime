...
#ifndef UNITTEST_OHOS_ABILITY_RUNTIME_ABILITY_MANAGER_STUB_MOCK_SECOND_H
#define UNITTEST_OHOS_ABILITY_RUNTIME_ABILITY_MANAGER_STUB_MOCK_SECOND_H
...
public:
    ...
    MOCK_METHOD1(RevokeDelegator, int32_t(const sptr<IRemoteObject> &token));
};
}  // namespace AAFwk
}  // namespace OHOS
