...
public:
    ...
    {
        if (DistributedKv::Status::SUCCESS == haveEntries_) {
    ...
    DistributedKv::Key testKey_ = "testkey";
    ...
    DistributedKv::Status haveEntries_ = DistributedKv::Status::SUCCESS;
    bool mockKvDataMgr_ = true;
};
} // namespace OHOS
#endif