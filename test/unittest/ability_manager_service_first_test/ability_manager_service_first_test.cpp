...
{
    TAG_LOGI(AAFwkTag::TEST, "AbilityManagerServiceFirstTest SendANRProcessID_001 start");
    auto abilityMs_ = std::make_shared<AbilityManagerService>();
    MyFlag::flag_ = 0;
    ...
    MyFlag::flag_ = 0;
    TAG_LOGI(AAFwkTag::TEST, "AbilityManagerServiceFirstTest SendANRProcessID_001 end");
}
