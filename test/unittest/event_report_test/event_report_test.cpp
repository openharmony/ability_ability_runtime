...
/**
 * @tc.name: SendExtensionEvent_1000
 * @tc.desc: Check SendExtensionEvent Test
 * @tc.type: FUNC
 * @tc.require: issueI67H0J
 */
HWTEST_F(EventReportTest, SendExtensionEvent_1000, TestSize.Level0)
{
...
{
    EventName eventName = EventName::BACKGROUND_EVENT_FORM;
 ...
 * @tc.require: issueI67H0J
 */
HWTEST_F(EventReportTest, SendFormEvent_1200, TestSize.Level0)
{
