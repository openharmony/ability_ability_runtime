...
// AgentConnectManager only constructs/stores AgentServiceConnection and reads AsObject()
// (inherited from AbilityConnectionStub); it never invokes the AMS callbacks below.
