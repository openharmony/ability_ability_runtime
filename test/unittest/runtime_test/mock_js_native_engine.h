...
#ifndef MOCK_JS_NATIVE_ENGINE_H
#define MOCK_JS_NATIVE_ENGINE_H

#include "gmock/gmock.h"
#include "native_engine/native_engine.h"

class MockJsNativeEngine : public NativeEngine {
public:
    MockJsNativeEngine() : NativeEngine(nullptr)
    {}
    ...
    {
        GTEST_LOG_(INFO) << "MockJsNativeEngine::DumpHeapSnapshot called";
    }
