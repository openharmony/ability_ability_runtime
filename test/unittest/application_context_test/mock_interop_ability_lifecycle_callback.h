...
#ifndef OHOS_ABILITY_RUNTIME_CONTEXT_MOCK_INTEROP_ABILITY_LIFECYCLE_CALLBACK_H
#define OHOS_ABILITY_RUNTIME_CONTEXT_MOCK_INTEROP_ABILITY_LIFECYCLE_CALLBACK_H

#include "interop_ability_lifecycle_callback.h"

namespace OHOS {
namespace AbilityRuntime {
class MockInteropAbilityLifecycleCallback : public InteropAbilityLifecycleCallback {
public:
...
#endif  // OHOS_ABILITY_RUNTIME_CONTEXT_MOCK_INTEROP_ABILITY_LIFECYCLE_CALLBACK_H