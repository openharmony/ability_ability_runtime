...
{
    AAFwk::MyStatus::GetInstance().setApplicationClientCalled_ = true;
}

const std::string &AppRunningRecord::GetBundleName() const
{
    AAFwk::MyStatus::GetInstance().getBundleNameCalled_ = true;
...
{
    AAFwk::MyStatus::GetInstance().getRecordIdCalled_ = true;
    return 0;
}
...
{
    AAFwk::MyStatus::GetInstance().getUidCalled_ = true;
    return 0;
}
...
{
    AAFwk::MyStatus::GetInstance().getStateCalled_ = true;
    return curState_;
}

void AppRunningRecord::SetState(const ApplicationState state)
{
    AAFwk::MyStatus::GetInstance().setStateCalled_ = true;
    curState_ = state;
}
...
{
    if (AAFwk::MyStatus::GetInstance().abilitiesMap_.empty()) {
        return false;
    }
    return true;
}
...
{
    // Track successful ability launch
    AAFwk::MyStatus::GetInstance().startAbility_launchAbility_called_ = true;
}
...
{
    AAFwk::MyStatus::GetInstance().scheduleForegroundRunningCalled_ = true;
    return false;
}
...
{
    // Track if AddModule is called, used for checking module creation success/failure
    AAFwk::MyStatus::GetInstance().addModuleCalled_ = true;
    AAFwk::MyStatus::GetInstance().addModuleCalledTimes_++;
    // Simulate module creation failure scenario
    if (AAFwk::MyStatus::GetInstance().simulateAddModuleFails_) {
        AAFwk::MyStatus::GetInstance().startAbility_addModuleFailed_called_ = true;
        return;
    }
    if (AAFwk::MyStatus::GetInstance().simulateAddAbilityFails_) {
        AAFwk::MyStatus::GetInstance().startAbility_addAbilityFailed_called_ = true;
        return;
    }
}
...
{
    // Track if GetModuleRecordByModuleName is called
    AAFwk::MyStatus::GetInstance().getModuleRecordByModuleNameCalled_ = true;
    
    // Return nullptr to simulate module creation failure
    if (AAFwk::MyStatus::GetInstance().simulateAddModuleFails_) {
        return nullptr;
    }
...
std::shared_ptr<AbilityRunningRecord> AppRunningRecord::GetAbilityRunningRecordByToken(
    const sptr<IRemoteObject> &token) const
{
    AAFwk::MyStatus::GetInstance().getAbilityRunningRecordByTokenCalledAppRecord_ = true;
    // Track singleton mode scenarios
    if (AAFwk::MyStatus::GetInstance().simulateSingletonAbilityExists_) {
        AAFwk::MyStatus::GetInstance().startAbility_singletonAbilityExists_called_ = true;
        return AAFwk::MyStatus::GetInstance().getAbilityRunningRecordByToken_;
    }
    
    // Track existing ability with preToken scenario
    if (AAFwk::MyStatus::GetInstance().simulateAbilityExistsWithPreToken_) {
        AAFwk::MyStatus::GetInstance().startAbility_abilityExistsWithPreToken_called_ = true;
        return AAFwk::MyStatus::GetInstance().getAbilityRunningRecordByToken_;
    }
    
    // Return nullptr to simulate ability creation failure
    if (AAFwk::MyStatus::GetInstance().simulateAddAbilityFails_) {
        return nullptr;
    }
    AAFwk::MyStatus::GetInstance().startAbility_nullAbilityInfo_called_ = false;
    AAFwk::MyStatus::GetInstance().startAbility_nullAppRecord_called_ = false;
    return AAFwk::MyStatus::GetInstance().getAbilityRunningRecordByToken_;
}
...
{
    AAFwk::MyStatus::GetInstance().appRunningRecordSetAppDeathRecipientCalled_ = true;
...
{
    AAFwk::MyStatus::GetInstance().isKeepAliveAppCalled_ = true;
...
{
    AAFwk::MyStatus::GetInstance().setKeepAliveEnableStateCalled_ = true;
...
{
    AAFwk::MyStatus::GetInstance().getBundleNamesCalled_ = true;
}
...
{
    AAFwk::MyStatus::GetInstance().getSpecifiedRequestIdCall_++;
    return -1;
}
...
{
    return AAFwk::MyStatus::GetInstance().isNewProcessRequest_;
}

bool AppRunningRecord::IsStartSpecifiedAbility() const
{
    return AAFwk::MyStatus::GetInstance().isStartSpecifiedAbility_;
}
...
{
    AAFwk::MyStatus::GetInstance().debugAppCalledTimes_++;
    return isDebugApp_;
}
...
{
    AAFwk::MyStatus::GetInstance().setApplicationScheduleStateCalled_ = true;
...
{
    AAFwk::MyStatus::GetInstance().removeChildProcessRecordCall_++;
}
...
{
    AAFwk::MyStatus::GetInstance().setAssertionPauseFlagCalled_ = true;
    isAssertPause_ = flag;
}
...
{
    AAFwk::MyStatus::GetInstance().getPidCall_ = true;
    return 0;
}
...
bool AppRunningRecord::IsAllAbilityReadyToCleanedByUserRequest()
{
    ...
    return AAFwk::MyStatus::GetInstance().isAllAbilityReadyToCleanedByUserRequest_;
}

void AppRunningRecord::SetUserRequestCleaning()
{
    AAFwk::MyStatus::GetInstance().setUserRequestCleaningCalled_ = true;
...
{
    AAFwk::MyStatus::GetInstance().addAppLifecycleEventCalled_= true;
}
...
{
    AAFwk::MyStatus::GetInstance().setNWebPreloadCalled_ = true;
