...
namespace {
const std::string SHELLCOMMANDDRESULT = "shell cmd result CCCCCCCCCCCCCCCCCCCCCCCCCCC";
const std::string CHANGESHELLCOMMANDDRESULT = "shell cmd result DDDDDDDDDDDDDDDDDDDDDDDDDDDDDD";
const int EXITCODE = 20;
const int CHANGEEXITCODE = 300;
}  // namespace

class ShellCmdResultModuleTest : public ::testing::Test {
public:
...
void ShellCmdResultModuleTest::SetUpTestCase()
{}

void ShellCmdResultModuleTest::TearDownTestCase()
{}

void ShellCmdResultModuleTest::SetUp()
{}

void ShellCmdResultModuleTest::TearDown()
{}

/**
 * @tc.number: Shell_Cmd_Result_Module_Test_0100
...
/**
 * @tc.number: Shell_Cmd_Result_Module_Test_0200
...
/**
 * @tc.number: Shell_Cmd_Result_Module_Test_0300
