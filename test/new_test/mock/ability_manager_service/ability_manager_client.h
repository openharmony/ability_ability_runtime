...
public:
    ...
    std::shared_ptr<MockAbilityManagerCollaborator> GetAbilityManagerCollaborator();
    int32_t StartAbility(const Want &want, int requestCode, int32_t userId)
    {
        return 0;
    }
private:
...
public:
    static bool isNullInstance_;
    static std::shared_ptr<MockAbilityManagerCollaborator> collaborator_;
};
}  // namespace AAFwk
}  // namespace OHOS
