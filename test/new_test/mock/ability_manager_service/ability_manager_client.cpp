...
std::shared_ptr<MockAbilityManagerCollaborator> AbilityManagerClient::GetAbilityManagerCollaborator()
{
    return collaborator_;
}

bool AbilityManagerClient::isNullInstance_ = false;
std::shared_ptr<AbilityManagerClient> AbilityManagerClient::instance_ = nullptr;
std::shared_ptr<MockAbilityManagerCollaborator> AbilityManagerClient::collaborator_ = nullptr;
}  // namespace AAFwk
}  // namespace OHOS