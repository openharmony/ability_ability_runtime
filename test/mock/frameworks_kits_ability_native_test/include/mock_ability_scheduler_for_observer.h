 ...
 */
#ifndef OHOS_ABILITY_RUNTIME_MOCK_ABILITY_SCHEDULER_FOR_OBESERVER_H
#define OHOS_ABILITY_RUNTIME_MOCK_ABILITY_SCHEDULER_FOR_OBESERVER_H
...
#endif /* OHOS_ABILITY_RUNTIME_MOCK_ABILITY_SCHEDULER_FOR_OBESERVER_H */
