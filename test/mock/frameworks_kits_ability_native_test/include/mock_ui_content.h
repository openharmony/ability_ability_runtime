...
public:
    ...
    MOCK_METHOD2(OnFormSurfaceChange, void(float width, float height, OHOS::Rosen::WindowSizeChangeReason reason,
    ...
    MOCK_METHOD2(UpdateSizeOfPopupUIExtension, void(int32_t nodeId, std::optional<PopupSize> &targetSize));
};

std::unique_ptr<Ace::UIContent> UIContent::Create(OHOS::AbilityRuntime::Context *, NativeEngine *)
{
    return std::make_unique<Ace::MockUIContent>();
}
} // namespace Ace
} // namespace OHOS
