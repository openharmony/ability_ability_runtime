...
#ifndef MOCK_OHOS_ABILITY_RUNTIME_MOCK_AMS_MGR_SERVICE_INNER_H
#define MOCK_OHOS_ABILITY_RUNTIME_MOCK_AMS_MGR_SERVICE_INNER_H

#include "ams_mgr_scheduler.h"

namespace OHOS {
namespace AppExecFwk {
class IAbilityToken : public AmsMgrScheduler {
public:
...
#endif  // MOCK_OHOS_ABILITY_RUNTIME_MOCK_AMS_MGR_SERVICE_INNER_H
