...
#ifndef MOCK_OHOS_ABILITY_RUNTIME_MOCK_FORM_MGR_SERVICE_H
#define MOCK_OHOS_ABILITY_RUNTIME_MOCK_FORM_MGR_SERVICE_H
...
#endif  // MOCK_OHOS_ABILITY_RUNTIME_MOCK_FORM_MGR_SERVICE_H
