...
#ifndef OHOS_ABILITY_RUNTIME_MOCK_APP_MGR_SERVICE_INNER_H
#define OHOS_ABILITY_RUNTIME_MOCK_APP_MGR_SERVICE_INNER_H
...
#endif  // OHOS_ABILITY_RUNTIME_MOCK_APP_MGR_SERVICE_INNER_H
