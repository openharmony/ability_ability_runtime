...
#ifndef OHOS_ABILITY_RUNTIME_MOCK_BUNDLE_MGR_SERVICE_H
#define OHOS_ABILITY_RUNTIME_MOCK_BUNDLE_MGR_SERVICE_H
...
#endif  // OHOS_ABILITY_RUNTIME_MOCK_BUNDLE_MGR_SERVICE_H
