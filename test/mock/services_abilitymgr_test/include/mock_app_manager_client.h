...
#ifndef OHOS_ABILITY_RUNTIME_MOCK_APP_MANAGER_CLIENT_H
#define OHOS_ABILITY_RUNTIME_MOCK_APP_MANAGER_CLIENT_H
...
#endif  // OHOS_ABILITY_RUNTIME_MOCK_APP_MANAGER_CLIENT_H
