...
public:
    ...
    MOCK_METHOD4(UpdateAbilityState, AppMgrResultCode(const sptr<IRemoteObject>& token,
        const AbilityState state, bool isFromScreenOffBackground, const UiAbilityLastCallerInfo& callerInfo));
