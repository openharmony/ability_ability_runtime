...
#ifndef OHOS_ABILITY_RUNTIME_MOCK_TEST_OBSERVER_STUB_H
#define OHOS_ABILITY_RUNTIME_MOCK_TEST_OBSERVER_STUB_H
...
#endif  // OHOS_ABILITY_RUNTIME_MOCK_TEST_OBSERVER_STUB_H
