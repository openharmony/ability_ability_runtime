...
#ifndef OHOS_ABILITY_RUNTIME_MOCK_ELEMENT_CALLBACK_H
#define OHOS_ABILITY_RUNTIME_MOCK_ELEMENT_CALLBACK_H
...
#endif  // OHOS_ABILITY_RUNTIME_MOCK_ELEMENT_CALLBACK_H
