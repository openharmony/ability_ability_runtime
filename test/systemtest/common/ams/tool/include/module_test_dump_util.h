...
#ifndef OHOS_ABILITY_RUNTIME_MODULE_TEST_DUMP_UTIL_H
#define OHOS_ABILITY_RUNTIME_MODULE_TEST_DUMP_UTIL_H
...
#endif  // OHOS_ABILITY_RUNTIME_MODULE_TEST_DUMP_UTIL_H
