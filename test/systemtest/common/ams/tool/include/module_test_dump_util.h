...
#ifndef SYSTEMTEST_OHOS_ABILITY_RUNTIME_MODULE_TEST_DUMP_UTIL_H
#define SYSTEMTEST_OHOS_ABILITY_RUNTIME_MODULE_TEST_DUMP_UTIL_H
...
#endif  // SYSTEMTEST_OHOS_ABILITY_RUNTIME_MODULE_TEST_DUMP_UTIL_H
