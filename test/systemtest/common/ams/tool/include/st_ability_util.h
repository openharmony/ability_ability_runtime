...
#ifndef SYSTEMTEST_OHOS_ABILITY_RUNTIME_ST_ABILITY_UTIL_H
#define SYSTEMTEST_OHOS_ABILITY_RUNTIME_ST_ABILITY_UTIL_H
#include "event.h"
...
#endif  // SYSTEMTEST_OHOS_ABILITY_RUNTIME_ST_ABILITY_UTIL_H
