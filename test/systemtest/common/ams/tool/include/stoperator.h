 ...
 */
#ifndef SYSTEMTEST_OHOS_ABILITY_RUNTIME_STOPERATOR_H
#define SYSTEMTEST_OHOS_ABILITY_RUNTIME_STOPERATOR_H
...
#endif  // SYSTEMTEST_OHOS_ABILITY_RUNTIME_STOPERATOR_H
