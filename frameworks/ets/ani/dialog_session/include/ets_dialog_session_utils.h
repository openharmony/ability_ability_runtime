...
#ifndef OHOS_ABILITY_RUNTIME_ETS_DIALOG_SESSION_UTILS_H
#define OHOS_ABILITY_RUNTIME_ETS_DIALOG_SESSION_UTILS_H
...
#endif // OHOS_ABILITY_RUNTIME_ETS_DIALOG_SESSION_UTILS_H
