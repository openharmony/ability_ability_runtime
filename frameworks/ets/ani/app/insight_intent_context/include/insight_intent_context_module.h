...
#ifndef OHOS_ABILITY_RUNTIME_INSIGHT_CONTEXT_MODULE_H
#define OHOS_ABILITY_RUNTIME_INSIGHT_CONTEXT_MODULE_H
...
class EtsInsightIntentContextModule {
public:
    EtsInsightIntentContextModule() = default;
    ~EtsInsightIntentContextModule() = default;

    EtsInsightIntentContextModule(const EtsInsightIntentContextModule &) = delete;
    EtsInsightIntentContextModule(EtsInsightIntentContextModule &&) = delete;
    EtsInsightIntentContextModule &operator=(const EtsInsightIntentContextModule &) = delete;
    EtsInsightIntentContextModule &operator=(EtsInsightIntentContextModule &&) = delete;
...
#endif // OHOS_ABILITY_RUNTIME_INSIGHT_CONTEXT_MODULE_H
