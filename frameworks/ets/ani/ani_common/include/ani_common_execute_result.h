...
#ifndef OHOS_ABILITY_RUNTIME_ANI_COMMON_EXECUTE_RESULT_H
#define OHOS_ABILITY_RUNTIME_ANI_COMMON_EXECUTE_RESULT_H
...
#endif // OHOS_ABILITY_RUNTIME_ANI_COMMON_EXECUTE_RESULT_H
