...
ani_status BindNativeFunctions(ani_env *env)
{
    ...
    std::array functions = {
        ani_native_function { "nativeGetBundleName", "C{std.core.Object}C{utils.AbilityUtils.AsyncCallbackWrapper}:",
            reinterpret_cast<void *>(EtsWantAgent::GetBundleName) },
        ani_native_function { "nativeGetUid", "C{std.core.Object}C{utils.AbilityUtils.AsyncCallbackWrapper}:",
            reinterpret_cast<void *>(EtsWantAgent::GetUid) },
        ani_native_function { "nativeGetOperationType", "C{std.core.Object}C{utils.AbilityUtils.AsyncCallbackWrapper}:",
            reinterpret_cast<void *>(EtsWantAgent::GetOperationType) },
        ani_native_function { "nativeCancel", "C{std.core.Object}C{utils.AbilityUtils.AsyncCallbackWrapper}:",
            reinterpret_cast<void *>(EtsWantAgent::Cancel) },
        ani_native_function { "nativeEqual",
            "C{std.core.Object}C{std.core.Object}C{utils.AbilityUtils.AsyncCallbackWrapper}:",
            reinterpret_cast<void *>(EtsWantAgent::Equal) },
        ani_native_function { "nativeTrigger",
            "C{std.core.Object}C{wantAgent.triggerInfo.TriggerInfo}C{utils.AbilityUtils.AsyncCallbackWrapper}:",
            reinterpret_cast<void *>(EtsWantAgent::Trigger) },
        ani_native_function { "nativeGetWant", "C{std.core.Object}C{utils.AbilityUtils.AsyncCallbackWrapper}:",
            reinterpret_cast<void *>(EtsWantAgent::GetWant) },
        ani_native_function { "nativeGetWantAgent",
            "C{wantAgent.wantAgentInfo.WantAgentInfo}C{utils.AbilityUtils.AsyncCallbackWrapper}:",
