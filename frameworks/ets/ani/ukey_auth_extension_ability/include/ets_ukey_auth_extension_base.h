...
#ifndef OHOS_ABILITY_RUNTIME_ETS_UKEY_AUTH_UI_EXTENSION_BASE_H
#define OHOS_ABILITY_RUNTIME_ETS_UKEY_AUTH_UI_EXTENSION_BASE_H
...
public:
    explicit EtsUkeyAuthExtensionBase(const std::unique_ptr<Runtime> &runtime);
...
#endif // OHOS_ABILITY_RUNTIME_ETS_UKEY_AUTH_UI_EXTENSION_BASE_H
