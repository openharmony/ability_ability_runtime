...
#include "ets_ukey_auth_ui_extension.h"
...
EtsUkeyAuthUIExtension *EtsUkeyAuthUIExtension::Create(const std::unique_ptr<Runtime> &runtime)
{
    return new EtsUkeyAuthUIExtension(runtime);
}
...
EtsUkeyAuthUIExtension::~EtsUkeyAuthUIExtension()
{
...
ETS_EXPORT extern "C" OHOS::AbilityRuntime::UkeyAuthUIExtension *OHOS_ETS_UkeyAuth_Extension_Create(
    const std::unique_ptr<OHOS::AbilityRuntime::Runtime> &runtime)
{
    return OHOS::AbilityRuntime::EtsUkeyAuthUIExtension::Create(runtime);
}
