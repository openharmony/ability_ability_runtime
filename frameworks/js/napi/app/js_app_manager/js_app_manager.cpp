...
private:
    ...
    NativeValue* OnkillProcessesByBundleName(NativeEngine &engine, const NativeCallbackInfo &info)
    {
        ...
        NativeValue* result = nullptr;
        AsyncTask::ScheduleHighQos("JSAppManager::OnkillProcessesByBundleName",
            engine, CreateAsyncTaskWithLastParam(engine, lastParam, nullptr, std::move(complete), &result));
        return result;
    }
    ...
    NativeValue* OnIsSharedBundleRunning(NativeEngine &engine, const NativeCallbackInfo &info)
    {
        ...
        NativeValue* result = nullptr;
        AsyncTask::ScheduleHighQos("JSAppManager::OnIsSharedBundleRunning",
            engine, CreateAsyncTaskWithLastParam(engine, lastParam, nullptr, std::move(complete), &result));
        return result;
    }
    ...
    NativeValue* OnGetProcessMemoryByPid(NativeEngine& engine, const NativeCallbackInfo& info)
    {
        ...
        NativeValue* lastParam = (info.argc == ARGC_TWO) ? info.argv[INDEX_ONE] : nullptr;
        NativeValue* result = nullptr;
        AsyncTask::ScheduleHighQos("JSAppManager::OnGetProcessMemoryByPid",
            engine, CreateAsyncTaskWithLastParam(engine, lastParam, nullptr, std::move(complete), &result));
        return result;
    }
    ...
    NativeValue* OnGetRunningProcessInfoByBundleName(NativeEngine& engine, const NativeCallbackInfo& info)
    {
        ...
        NativeValue* result = nullptr;
        AsyncTask::ScheduleHighQos("JSAppManager::OnGetRunningProcessInfoByBundleName",
            engine, CreateAsyncTaskWithLastParam(engine, lastParam, nullptr, std::move(complete), &result));
        return result;
    }
