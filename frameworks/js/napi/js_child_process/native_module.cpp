...
void NAPI_app_ability_ChildProcess_AutoRegister()
{
...
void NAPI_app_ability_ChildProcess_GetJSCode(const char **buf, int *bufLen)
{
    if (buf != nullptr) {
...
extern "C" __attribute__((visibility("default")))
void NAPI_app_ability_ChildProcess_GetABCCode(const char **buf, int *buflen)
{
    if (buf != nullptr) {
