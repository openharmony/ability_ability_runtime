...
JsUkeyAuthUIExtension *JsUkeyAuthUIExtension::Create(const std::unique_ptr<Runtime> &runtime)
{
    return new JsUkeyAuthUIExtension(runtime);
}
...
JsUkeyAuthUIExtension::~JsUkeyAuthUIExtension()
{
