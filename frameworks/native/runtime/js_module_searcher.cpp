...
std::string JsModuleSearcher::ParseOhmUri(
    const std::string& originBundleName, const std::string& curJsModulePath, const std::string& newJsModuleUri) const
{
...
std::string JsModuleSearcher::NormalizeUri(
