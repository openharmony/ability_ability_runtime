...
#ifndef FOUNDATION_ABILITY_RUNTIME_CONNECT_SERVER_MANAGER_H
#define FOUNDATION_ABILITY_RUNTIME_CONNECT_SERVER_MANAGER_H
...
#endif // FOUNDATION_ABILITY_RUNTIME_CONNECT_SERVER_MANAGER_H