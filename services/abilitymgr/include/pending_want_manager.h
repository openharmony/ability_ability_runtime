...
public:
    ...
    int32_t PendingWantStartAbility(const Want &want, const sptr<IRemoteObject> &callerToken,
    ...
    int32_t PendingWantStartAbilitys(const std::vector<WantsInfo> wnatsInfo, const sptr<IRemoteObject> &callerToken,
        int32_t requestCode, const int32_t callerUid, int32_t callerTokenId);
    int32_t DeviceIdDetermine(const Want &want, const sptr<IRemoteObject> &callerToken, int32_t requestCode,
