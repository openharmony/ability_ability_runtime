...
#ifndef OHOS_ABILITY_RUNTIME_WINDOW_VISIBILITY_CHANGE_LISTENER_H
#define OHOS_ABILITY_RUNTIME_WINDOW_VISIBILITY_CHANGE_LISTENER_H
...
#endif // OHOS_ABILITY_RUNTIME_WINDOW_VISIBILITY_CHANGE_LISTENER_H
