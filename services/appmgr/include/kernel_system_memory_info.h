 ...
 */
#ifndef OHOS_ABILITY_RUNTIME_KERNEL_SYSTEM_MEMORY_INFO_H
#define OHOS_ABILITY_RUNTIME_KERNEL_SYSTEM_MEMORY_INFO_H
...
#endif // OHOS_ABILITY_RUNTIME_KERNEL_SYSTEM_MEMORY_INFO_H
