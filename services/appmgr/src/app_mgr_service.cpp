...
int32_t AppMgrService::IsSpecifiedModuleLoaded(const AAFwk::Want &want, const AbilityInfo &abilityInfo,
    bool isSpecifiedProcess, bool &result, bool &isDebug)
{
    ...
    result = appMgrServiceInner_->IsSpecifiedModuleLoaded(want, abilityInfo, isSpecifiedProcess, isDebug);
    return ERR_OK;
}
