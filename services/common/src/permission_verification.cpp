...
bool PermissionVerification::VerifyPermissionForTokenId(const int &tokenId, const std::string &permissionName) const
{
    HILOG_DEBUG("VerifyPermissionForTokenId permission %{public}s", permissionName.c_str());
