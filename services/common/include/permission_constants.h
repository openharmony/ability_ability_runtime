...
constexpr const char* PERMISSION_CONNECT_AGENT = "ohos.permission.CONNECT_AGENT";
constexpr const char* PERMISSION_START_SYSTEM_DIALOG = "ohos.permission.START_SYSTEM_DIALOG";
...
constexpr const char* PERMISSION_SWITCH_KIOSK_MODE = "ohos.permission.SWITCH_KIOSK_MODE";
