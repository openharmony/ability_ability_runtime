...
2. 优先审计 IPC 密集模块（services/abilitymgr, services/appmgr）
3. 关注 `frameworks/native/` 和 `services/` 目录
4. NAPI 绑定层（frameworks/js/napi/）重点检查 napi_get_value_* 获取的参数是否在持久化前校验
