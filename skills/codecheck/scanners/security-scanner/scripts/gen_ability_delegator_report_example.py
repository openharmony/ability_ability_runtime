...
"""
Historical example: hardcoded security-scanner Excel report for
frameworks/js/napi/app/ability_delegator.

For new scans, use the generic generator instead:
  .claude/skills/security-scanner/scripts/generate_report.py

Consolidates findings from security-scanner (bug + security merged).
"""
