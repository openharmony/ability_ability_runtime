...
#ifndef OHOS_ABILITY_RUNTIME_ETS_TEST_RUNNER_INSTANCE_H
#define OHOS_ABILITY_RUNTIME_ETS_TEST_RUNNER_INSTANCE_H
...
#endif // OHOS_ABILITY_RUNTIME_ETS_TEST_RUNNER_INSTANCE_H