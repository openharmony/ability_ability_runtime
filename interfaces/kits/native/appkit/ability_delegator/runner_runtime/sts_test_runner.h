...
#ifndef OHOS_ABILITY_RUNTIME_STS_TEST_RUNNER_H
#define OHOS_ABILITY_RUNTIME_STS_TEST_RUNNER_H
...
class STSTestRunner : public TestRunner {
public:
    /**
...
#endif  // OHOS_ABILITY_RUNTIME_STS_TEST_RUNNER_H
