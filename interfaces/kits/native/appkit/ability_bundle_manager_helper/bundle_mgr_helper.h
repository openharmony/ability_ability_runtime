...
public:
    ...
    ErrCode QuerySandboxCloneAbilityInfo(const std::string &creatorBundleName,
    ...
    ErrCode GetDualModeBundleInfo(const std::string &bundleName, int32_t userId, int32_t &appIndex);
