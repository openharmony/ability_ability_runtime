...
constexpr const char* ETS_ABILITY_STAGE_CLASS_NAME = "L@ohos/app/ability/AbilityStage/AbilityStage;";
constexpr const char* ETS_HAPMODULEINFO_CLASS_NAME = "LbundleManager/HapModuleInfoInner/HapModuleInfoInner;";
