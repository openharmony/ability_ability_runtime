...
#ifndef OHOS_ABILITY_RUNTIME_ETS_EXTENSION_CONTEXT_H
#define OHOS_ABILITY_RUNTIME_ETS_EXTENSION_CONTEXT_H
...
#endif // OHOS_ABILITY_RUNTIME_ETS_EXTENSION_CONTEXT_H