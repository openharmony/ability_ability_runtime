...
#ifndef OHOS_ABILITY_RUNTIME_CONTINUATION_CONNECTOR_H
#define OHOS_ABILITY_RUNTIME_CONTINUATION_CONNECTOR_H
...
#endif  // OHOS_ABILITY_RUNTIME_CONTINUATION_CONNECTOR_H
