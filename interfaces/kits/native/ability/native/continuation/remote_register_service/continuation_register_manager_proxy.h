 ...
 */
#ifndef OHOS_ABILITY_RUNTIME_CONTINUATION_REGISTER_MANAGER_PROXY_H
#define OHOS_ABILITY_RUNTIME_CONTINUATION_REGISTER_MANAGER_PROXY_H
...
#endif  // OHOS_ABILITY_RUNTIME_CONTINUATION_REGISTER_MANAGER_PROXY_H
