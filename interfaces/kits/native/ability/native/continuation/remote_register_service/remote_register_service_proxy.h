...
#ifndef OHOS_ABILITY_RUNTIME_REMOTE_REGISTER_SERVICE_PROXY_H
#define OHOS_ABILITY_RUNTIME_REMOTE_REGISTER_SERVICE_PROXY_H
...
#endif  // OHOS_ABILITY_RUNTIME_REMOTE_REGISTER_SERVICE_PROXY_H
