...
#ifndef OHOS_ABILITY_RUNTIME_DISTRIBUTE_SCHEDULE_HANDLER_INTERFACE_H
#define OHOS_ABILITY_RUNTIME_DISTRIBUTE_SCHEDULE_HANDLER_INTERFACE_H
...
#endif  // OHOS_ABILITY_RUNTIME_DISTRIBUTE_SCHEDULE_HANDLER_INTERFACE_H
