 ...
 */
#ifndef OHOS_ABILITY_RUNTIME_CONTINUATION_DEVICE_CALLBACK_INTERFACE_H
#define OHOS_ABILITY_RUNTIME_CONTINUATION_DEVICE_CALLBACK_INTERFACE_H
...
#endif  // OHOS_ABILITY_RUNTIME_CONTINUATION_DEVICE_CALLBACK_INTERFACE_H
