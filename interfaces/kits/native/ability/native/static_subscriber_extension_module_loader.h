...
#ifndef OHOS_ABILITY_RUNTIME_STATIC_SUBSCRIBER_EXTENSION_MODULE_LOADER_H
#define OHOS_ABILITY_RUNTIME_STATIC_SUBSCRIBER_EXTENSION_MODULE_LOADER_H

#include "extension_module_loader.h"

namespace OHOS {
namespace AbilityRuntime {
class StaticSubscriberExtensionModuleLoader : public ExtensionModuleLoader,
...
#endif // OHOS_ABILITY_RUNTIME_STATIC_SUBSCRIBER_EXTENSION_MODULE_LOADER_H
