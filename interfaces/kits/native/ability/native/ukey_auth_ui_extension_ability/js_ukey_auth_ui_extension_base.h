...
/**
 * @brief JsUIExtensionBase subclass binding the public UkeyAuthUIExtensionContext.
 */
class JsUkeyAuthUIExtensionBase : public JsUIExtensionBase {
public:
    explicit JsUkeyAuthUIExtensionBase(const std::unique_ptr<Runtime> &runtime);
    ~JsUkeyAuthUIExtensionBase() override = default;
...
private:
    ...
    std::shared_ptr<UkeyAuthUIExtensionContext> ukeyContext_ = nullptr;
};
} // namespace AbilityRuntime
} // namespace OHOS
