...
/**
 * @brief Js wrapper for UkeyAuthUIExtensionContext, binding only the four public methods.
 */
class JsUkeyAuthUIExtensionContext {
public:
    explicit JsUkeyAuthUIExtensionContext(const std::shared_ptr<UkeyAuthUIExtensionContext> &context)
        : context_(context) {}
    virtual ~JsUkeyAuthUIExtensionContext() = default;
    ...
    static napi_value CreateJsUkeyAuthUIExtensionContext(napi_env env,
