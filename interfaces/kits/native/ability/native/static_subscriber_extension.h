...
#ifndef OHOS_ABILITY_RUNTIME_STATIC_SUBSCRIBER_EXTENSION_H
#define OHOS_ABILITY_RUNTIME_STATIC_SUBSCRIBER_EXTENSION_H
...
#endif  // OHOS_ABILITY_RUNTIME_STATIC_SUBSCRIBER_EXTENSION_H
