...
#ifndef OHOS_ABILITY_RUNTIME_ABILITY_LIFECYCLE_OBSERVER_H
#define OHOS_ABILITY_RUNTIME_ABILITY_LIFECYCLE_OBSERVER_H
...
#endif  // OHOS_ABILITY_RUNTIME_ABILITY_LIFECYCLE_OBSERVER_H
