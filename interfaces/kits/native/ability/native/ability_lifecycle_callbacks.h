...
#ifndef OHOS_ABILITY_RUNTIME_ABILITY_LIFECYCLE_CALLBACK_H
#define OHOS_ABILITY_RUNTIME_ABILITY_LIFECYCLE_CALLBACK_H
...
#endif  // OHOS_ABILITY_RUNTIME_ABILITY_LIFECYCLE_CALLBACK_H
