...
public:
     ...
     * This overload uses UnsupportedTypePolicy::SKIP when serializing extraInfo.
     *
     ...
     *
     * @param agent WantAgent object.
     * @param policy Policy for handling unsupported WantParams types.
     * @return WantAgentInfo object's serialized string.
     */
    static std::string ToStringWithEnvelope(const std::shared_ptr<WantAgent> &agent,
     ...
     * This overload uses UnsupportedTypePolicy::SKIP when parsing extraInfo.
     *
    ...
    /**
     * Parse a WantAgent string using the specified unsupported-type policy for extraInfo.
     *
     * @param jsonString String to parse.
     ...
     * @return WantAgentInfo object.
     */
    static std::shared_ptr<WantAgent> FromStringWithEnvelope(const std::string &jsonString, int32_t uid,
        AAFwk::WantParamWrapperJson::UnsupportedTypePolicy policy);
