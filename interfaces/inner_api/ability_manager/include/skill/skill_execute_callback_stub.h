...
#ifndef OHOS_ABILITY_RUNTIME_SKILL_EXECUTE_CALLBACK_STUB_H
...
namespace OHOS {
namespace AAFwk {
class SkillExecuteCallbackStub : public IRemoteStub<ISkillExecuteCallback> {
public:
...
#endif // OHOS_ABILITY_RUNTIME_SKILL_EXECUTE_CALLBACK_STUB_H
