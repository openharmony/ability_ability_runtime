...
#ifndef OHOS_ABILITY_RUNTIME_EXTENSION_RUNNING_INFO_H
#define OHOS_ABILITY_RUNTIME_EXTENSION_RUNNING_INFO_H
...
#endif  // OHOS_ABILITY_RUNTIME_EXTENSION_RUNNING_INFO_H
