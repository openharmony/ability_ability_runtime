...
#ifndef OHOS_ABILITY_RUNTIME_ATOMIC_SERVICE_STATUS_CALLBACK_INTERFACE_H
#define OHOS_ABILITY_RUNTIME_ATOMIC_SERVICE_STATUS_CALLBACK_INTERFACE_H
...
#endif  // OHOS_ABILITY_RUNTIME_ATOMIC_SERVICE_STATUS_CALLBACK_INTERFACE_H
