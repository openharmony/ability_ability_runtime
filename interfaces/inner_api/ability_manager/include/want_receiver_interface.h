...
#ifndef OHOS_ABILITY_RUNTIME_WANT_RECEIVER_INTERFACE_H
#define OHOS_ABILITY_RUNTIME_WANT_RECEIVER_INTERFACE_H
...
#endif  // OHOS_ABILITY_RUNTIME_WANT_RECEIVER_INTERFACE_H
