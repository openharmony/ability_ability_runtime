...
private:
    ...
    int32_t HandleNotifyMemonySizeStateChanged(MessageParcel &data, MessageParcel &reply);
    int32_t HandleSetSupportProcessCacheSelf(MessageParcel &data, MessageParcel &reply);
