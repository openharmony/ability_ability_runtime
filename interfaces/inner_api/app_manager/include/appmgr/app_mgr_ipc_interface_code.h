...
enum class AppMgrInterfaceCode {
    ...
    CREATE_NATIVE_CHILD_PROCESS = 76,
    ...
    UPDATE_CONFIGURATION_POLICY = 107,
    DUMP_CJHEAP_MEMORY_PROCESS = 108,
    PROMOTE_CURRENT_TO_CANDIDATE_MASTER_PROCESS = 109,
    DEMOTE_CURRENT_FROM_CANDIDATE_MASTER_PROCESS = 110,
    PRELOAD_MODULE_FINISHED = 111,
    QUERY_RUNNING_SHARED_BUNDLES = 112,
    EXIT_MASTER_PROCESS_ROLE = 113,
    REGISTER_APPLICATION_STATE_OBSERVER_WITH_FILTER = 114,
    UPDATE_CONFIGURATION_MULTI_USER = 115,
    GET_CONFIGURATION_BY_USERID = 116,
    SET_SPECIFIED_PROCESS_REQUEST_ID = 117,
    IS_APP_RUNNING_BY_USER_ID = 118,
    ALLOW_SCB_PROCESS_MOVE_TO_BACKGROUND = 119,
    KILL_PROCESS_BY_PID_FOR_EXIT = 120,
    ...
    ENABLE_DELAYED_PROCESS_EXIT = 135,
    CANCEL_DELAYED_EXIT_TASK = 136,
    IS_CHILD_PROCESS_SUPPORTED = 137,
    ...
    PRE_TEMPLATE_PROCESS_DEEP_FROZEN = 142,
    NOTIFY_TEMPLATE_PROCESS_READY_DONE = 143,
    GET_SELF_UIABILITY_CHILD_PROCESSES = 144,
    GET_SELF_CHILDREN_PROCESSES = 145,
    GET_HYPER_SNAP_LAST_ERROR = 146,
};
} // AppExecFwk
} // OHOS
