...
#ifndef OHOS_ABILITY_RUNTIME_HYPER_SNAP_ERROR_RECORD_H
#define OHOS_ABILITY_RUNTIME_HYPER_SNAP_ERROR_RECORD_H
...
#endif // OHOS_ABILITY_RUNTIME_HYPER_SNAP_ERROR_RECORD_H
