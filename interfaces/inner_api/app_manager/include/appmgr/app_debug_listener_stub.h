...
#ifndef OHOS_ABILITY_RUNTIME_APP_DEBUG_LISTENER_STUB_H
#define OHOS_ABILITY_RUNTIME_APP_DEBUG_LISTENER_STUB_H
...
class AppDebugListenerStub : public IRemoteStub<IAppDebugListener> {
public:
    AppDebugListenerStub();
    virtual ~AppDebugListenerStub();
...
#endif // OHOS_ABILITY_RUNTIME_APP_DEBUG_LISTENER_STUB_H
