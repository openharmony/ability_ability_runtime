...
#ifndef OHOS_ABILITY_RUNTIME_RENDER_STATE_OBSERVER_STUB_H
#define OHOS_ABILITY_RUNTIME_RENDER_STATE_OBSERVER_STUB_H
...
class RenderStateObserverStub : public IRemoteStub<IRenderStateObserver> {
public:
    RenderStateObserverStub();
    virtual ~RenderStateObserverStub();
...
#endif // OHOS_ABILITY_RUNTIME_RENDER_STATE_OBSERVER_STUB_H