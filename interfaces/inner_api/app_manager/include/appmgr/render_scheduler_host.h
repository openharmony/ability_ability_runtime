...
#ifndef OHOS_ABILITY_RUNTIME_RENDER_SCHEDULER_HOST_H
#define OHOS_ABILITY_RUNTIME_RENDER_SCHEDULER_HOST_H
...
#endif  // OHOS_ABILITY_RUNTIME_RENDER_SCHEDULER_HOST_H
