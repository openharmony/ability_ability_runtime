...
MemDumpCallbackProxy::MemDumpCallbackProxy(const sptr<IRemoteObject> &impl)
    : IRemoteProxy<IMemDumpCallback>(impl)
{}

bool MemDumpCallbackProxy::WriteInterfaceToken(MessageParcel &data)
{
    if (!data.WriteInterfaceToken(MemDumpCallbackProxy::GetDescriptor())) {
...
void MemDumpCallbackProxy::OnMemDumpDone(const std::string &dumpResult)
{
    MessageParcel data;
