...
#ifndef OHOS_ABILITYRUNTIME_FOREGROUND_APP_CONNECTION_ERRORS_H
#define OHOS_ABILITYRUNTIME_FOREGROUND_APP_CONNECTION_ERRORS_H
...
#endif  // OHOS_ABILITYRUNTIME_FOREGROUND_APP_CONNECTION_ERRORS_H