...
#ifndef ABILITY_RUNTIME_FOREGROUND_APP_CONNECTION_DATA_H
#define ABILITY_RUNTIME_FOREGROUND_APP_CONNECTION_DATA_H

#include "parcel.h"

namespace OHOS {
namespace AbilityRuntime {
struct ForegroundAppConnectionData : public Parcelable {
    /**
     ...
     * @param parcel Indicates the Parcel object into which the Sequenceable object has been marshaled.
     */
    static ForegroundAppConnectionData *Unmarshalling(Parcel &parcel);
...
#endif  // ABILITY_RUNTIME_FOREGROUND_APP_CONNECTION_DATA_H
