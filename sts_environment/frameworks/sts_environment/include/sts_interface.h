...
#ifndef OHOS_ABILITY_STS_ENVIRONMENT_STS_INTERFACE_H
#define OHOS_ABILITY_STS_ENVIRONMENT_STS_INTERFACE_H
...
#endif // OHOS_ABILITY_STS_ENVIRONMENT_STS_INTERFACE_H
